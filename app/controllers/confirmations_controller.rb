class ConfirmationsController < ApplicationController
  ...
  private
    ...
    def confirmation_params
      params.require(:confirmation).permit(:document_id, :express_rating, :expert_conclusion, :confirmation, :document_type, :serial, :number, :issue_date, :country_id, :education_organization, :issue_orgenization, :foreign_level, :rf_level, :reason, :person)
    end
end
