...
class FloorsControllerTest < ActionController::TestCase
  ...
  test "should create floor" do
    assert_difference('Floor.count') do
      post :create, floor: { floor_number: @floor.floor_number, hostel_id: @floor.hostel_id, rooms_count: @floor.rooms_count }
    end
  ...
  test "should update floor" do
    patch :update, id: @floor, floor: { floor_number: @floor.floor_number, hostel_id: @floor.hostel_id, rooms_count: @floor.rooms_count }
    assert_redirected_to floor_path(assigns(:floor))
  end
