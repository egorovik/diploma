...
class HostelsControllerTest < ActionController::TestCase
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post :create, hostel: { address: @hostel.address, floors_count: @hostel.floors_count, name: @hostel.name }
    end
  ...
  test "should update hostel" do
    patch :update, id: @hostel, hostel: { address: @hostel.address, floors_count: @hostel.floors_count, name: @hostel.name }
    assert_redirected_to hostel_path(assigns(:hostel))
  end
