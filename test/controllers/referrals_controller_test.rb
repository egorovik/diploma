...
class ReferralsControllerTest < ActionController::TestCase
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post :create, referral: { date: @referral.date, payment: @referral.payment, referral_number: @referral.referral_number, speciality_id: @referral.speciality_id, student_id: @referral.student_id }
    end
  ...
  test "should update referral" do
    patch :update, id: @referral, referral: { date: @referral.date, payment: @referral.payment, referral_number: @referral.referral_number, speciality_id: @referral.speciality_id, student_id: @referral.student_id }
    assert_redirected_to referral_path(assigns(:referral))
  end
