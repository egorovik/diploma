...
class RestrictionsControllerTest < ActionController::TestCase
  ...
  test "should create restriction" do
    assert_difference('Restriction.count') do
      post :create, restriction: { restriction: @restriction.restriction, restriction_type: @restriction.restriction_type, student_left_id: @restriction.student_left_id, student_right_id: @restriction.student_right_id }
    end
  ...
  test "should update restriction" do
    patch :update, id: @restriction, restriction: { restriction: @restriction.restriction, restriction_type: @restriction.restriction_type, student_left_id: @restriction.student_left_id, student_right_id: @restriction.student_right_id }
    assert_redirected_to restriction_path(assigns(:restriction))
  end
